...
<div class="col-12 my-6 mb-0 wow fadeInUp" data-wow-delay="0.1s"> 
    <form action="issue_Licence2.php?id=<?php echo $row['l_id'];?>" method="POST">
    ...
    <tr><td>FROM DATE: <input type="date" style="background-color: red;" required name="fdate"> </td><td> TO DATE: <input type="date" required style="background-color: red;" name="todate"></td> </tr>
